...
import com.samuelganta.dao.LoginDao;
...
public class LoginServlet extends HttpServlet {
	...
	{
	request.setAttribute("name", userName); //with setAttribute() you can define a "key" and value pair so that you can get it in future using getAttribute("key")
